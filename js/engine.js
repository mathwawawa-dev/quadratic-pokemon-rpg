...
function resize() {
    ...
    // Pan limit: Y_MIN >= -40, Y_MAX <= 50
    let yCenter = (Y_MIN + Y_MAX) / 2;
    if (yCenter - yRange / 2 < -40) {
        yCenter = -40 + yRange / 2;
    }
...
function initStage() {
    ...
    if (stage.terrain === 'garden') {
        ...
        cloudParams = [
            ...
            { bx: -4, by: 25, speed: 3500, radius: 0.85, alpha: 0.8, isPowerCloud: true, colorType: starterData.type },
            { bx: 7,  by: 10, speed: 5000, radius: 0.5, alpha: 0.8, isPowerCloud: true, colorType: starterData.type },
            { bx: -2, by: 18, speed: 4000, radius: 0.75, alpha: 0.8, isPowerCloud: true, colorType: starterData.type }
        ];
    } else {
        cloudParams = [
            { bx: 5,  by: 18, speed: 3000, radius: 2.2, alpha: 0.6 },
