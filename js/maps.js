...
const TERRAINS = {
    ...
    cloud_garden: {
        name: "구름 공중정원",
        bg: ["#0f172a", "#1e293b", "#334155"], // 세련되고 눈이 편안한 딥 시안/슬레이트 스카이 배경
        color: "#67e8f9",   // 사진 스케치와 동일한 눈이 편안하고 매력적인 무광 민트 시안 구름섬 (#67e8f9 / #38bdf8 조합)
        outColor: "#0891b2", // 입체감을 주는 딥 시안 블루 윤곽 테두리 (#0891b2)
        isFloating: true,
        deathZoneY: -15,
        init: function(seed) {
            this.islands = [[], [], []];
