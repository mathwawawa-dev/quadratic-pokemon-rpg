...
fig.legend(handles=[
    Patch(facecolor='#1E90FF', edgecolor='#1E90FF', alpha=0.7,
          label='Case1: 1-digit int      L7/R7/T13/B4'),
    ...
    Patch(facecolor='#2ECC71', edgecolor='#2ECC71', alpha=0.7,
          label='Case3: root(1-digit)    L22/R29/T27/B15'),
    Patch(facecolor='#27AE60', edgecolor='#27AE60', alpha=0.7,
          label='Case4: root(2-digit)    L26/R34/T27/B15'),
    Patch(facecolor='#9B59B6', edgecolor='#9B59B6', alpha=0.7,
          label='Case5: n*root(1-digit)  L31/R34/T26/B15'),
    Patch(facecolor='#E67E22', edgecolor='#E67E22', alpha=0.7,
          label='Case6: n*root(2-digit)  L32/R39/T27/B15'),
...
fig.suptitle(
    'Gap Sample v6  -  6 cases (redefined)  |  4-directional asymmetric clearance\n'
    f'span={SPAN},  {PX:.0f}px/data_unit  @100DPI  |  '
    'navy = Left/Bottom     crimson = Right/Top',
    fontsize=10, fontweight='bold', y=0.97, color='#111'
)

OUT = r'C:\Users\user\Documents\삼각비 게임1\triangles4\gap_sample_visual6.png'
