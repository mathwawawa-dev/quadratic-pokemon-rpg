"""
gap_sample_visual5.py - 6 cases, all text English
"""
import re
...
CASE_CFG = {
    'case1': dict(L=8,  R=8,  T=13, B=4,
                  color='#1E90FF', desc='Case1: 1-digit int'),
    'case4': dict(L=11, R=11, T=13, B=4,
                  color='#00BFFF', desc='Case4: 2-digit int'),
    'case2': dict(L=22, R=29, T=26, B=15,
                  color='#2ECC71', desc='Case2: root(1d)'),
    'case5': dict(L=22, R=33, T=26, B=15,
                  color='#27AE60', desc='Case5: root(2d)'),
    'case3': dict(L=28, R=34, T=26, B=15,
                  color='#9B59B6', desc='Case3: n*root(1d)'),
    'case6': dict(L=28, R=37, T=26, B=15,
                  color='#E67E22', desc='Case6: n*root(2d)'),
}
...
fig.subplots_adjust(wspace=0.50, top=0.85, bottom=0.13)
...
fig.legend(handles=[
    ...
    Patch(facecolor='#E67E22', edgecolor='#E67E22', alpha=0.7,
          label='Case6: n*root(2-digit)   L28/R37/T26/B15'),
...
fig.suptitle(
    'Gap Sample v5  -  6 cases  |  4-directional asymmetric clearance\n'
    f'span={SPAN},  {PX:.0f}px/data_unit  @100DPI  |  '
    'navy = Left/Bottom     crimson = Right/Top',
    fontsize=10, fontweight='bold', y=0.97, color='#111'
)

OUT = r'C:\Users\user\Documents\삼각비 게임1\triangles4\gap_sample_visual5.png'
