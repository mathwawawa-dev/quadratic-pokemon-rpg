...
fig.suptitle(
    'Gap Sample FINAL (confirmed)  -  6 cases (redefined)  |  4-directional asymmetric clearance\n'
    f'span={SPAN},  {PX:.0f}px/data_unit  @100DPI  |  '
    'navy = Left/Bottom     crimson = Right/Top',
    fontsize=10, fontweight='bold', y=0.97, color='#111'
)

OUT = r'C:\Users\user\Documents\삼각비 게임1\triangles4\gap_sample_visual_final.png'
