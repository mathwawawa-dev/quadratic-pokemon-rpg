...
= 최대 180개 PNG → triangles4/type1_edited01/
...
TYPE1_DIR = os.path.join(ROOT, 'triangles4', 'type1_edited01')
...
mod.OUTPUT_DIR = TYPE1_DIR     # 출력 폴더를 type1_edited01/ 으로 override
draw = mod.draw
...
print(f"\n{'='*55}")
print(f"✅ 완료: {count}개 이미지 → triangles4/type1_edited01/")
