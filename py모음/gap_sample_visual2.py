...
CASE_CFG = {
    'case1': dict(L=8,  R=8,  T=14, B=6,
                  color='#1E90FF', name='Case1: Integer only'),
    'case2': dict(L=11, R=25, T=20, B=9,
                  color='#2ECC71', name='Case2: Root only'),
    'case3': dict(L=18, R=25, T=20, B=9,
...
fig.legend(handles=[
    Patch(facecolor='#1E90FF', edgecolor='#1E90FF', alpha=0.6,
          label='Case1 excl box  (L=8 / R=8 / T=14 / B=6 px)'),
    Patch(facecolor='#2ECC71', edgecolor='#2ECC71', alpha=0.6,
          label='Case2 excl box  (L=11 / R=25 / T=20 / B=9 px)'),
    Patch(facecolor='#9B59B6', edgecolor='#9B59B6', alpha=0.6,
          label='Case3 excl box  (L=18 / R=25 / T=20 / B=9 px)'),
...
fig.suptitle(
    'Gap Sample v2  -  Proposed 4-directional asymmetric clearance\n'
    f'span={SPAN},  scale={PX:.0f}px/data_unit  @100DPI',
    fontsize=11, fontweight='bold', y=0.97, color='#111'
)

OUT = r'C:\Users\user\Documents\삼각비 게임1\triangles4\gap_sample_visual2.png'
